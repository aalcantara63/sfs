      ...
      async fetchMenus(){ 
        ...
        try {
            ...
            if(responseSC.status === 200)
                store.commit('setMenuSinCatering', responseSC.data)
                const categoryMenuListSinCatering = await this.getCategoryMenu(responseSC.data) 
            ...
            if(responseCC.status === 200)
                store.commit('setMenuConCatering', responseCC.data) 
                const menuListConCatering = await this.getCategoryMenu(responseCC.data) 
