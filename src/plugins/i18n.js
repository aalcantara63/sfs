    ...
    en: {
        ...
        backoffice:{
            menu:{
                ...
                restaurantAdministration: 'Restaurant Administration',
                staffOccupationsCustomersDrivers: 'Staff/Occupations/Customers/Drivers',
                marketing: 'Marketing',
                settings: 'Settings',
            },
            controlPanel:{
                staff: 'Creation of user accounts for restaurant workers.',
                occupations: 'Management of restaurant occupations. Occupations are related to staff members. Each member has a specific occupation.',
                roles: 'Role management. The roles establish the permissions on the different areas of the application and are related to the staff members. A staff member can have multiple roles.',
                customers: 'Displays a list of the restaurants customers.',
                categories: 'Manage the different categories of the menus. Categories are related to menu items. A menu item belongs to a category.',
                menuItems: 'Management of menu items. A menu is made up of categories, and in turn, the menu items are related to the menu through the category to which it belongs.',
                services: 'Management of services. The services are used in the catering menus.',
                menus: 'Menu management. Allows menu management. A menu is made up of various categories.',
                orders: 'It allows the visualization and creation of orders.',
                cateringOrders: 'Allows the display of catering orders.',
                orderForDelivery: 'Displays a list of orders that are ready to be delivered to the driver who has been assigned the order.',
                tickets: 'Allows the creation and tracking of tickets. Tickets are orders that remain open while the customer continues to consume.',
                otherCharges: 'Allows the management of additional charges for quantity of products.',
                taxes: 'Tax management.',
                deliveries: 'Management of delivery prices.',
                reservations: 'Management of reservations and waiting lists.',
                tables: 'Management of restaurant capacities.',
                payments: 'Shows the list of payment transactions made.',
                aboutSettings: 'It allows the management of the slider that appears on the home page of each restaurant.',
                paymentSettings: 'It allows the configuration of the payment gateway that will be used to process transactions.',
                basicSettings: 'It allows the configuration of the main data of the restaurant: Name, Address, Telephone... This information appears on the home page of each restaurant.',
                funtionalitiesSettings: 'It allows the configuration of the general operation of the restaurant: Hours, Zip codes, tips...',
                colorSettings: 'It allows the configuration of the colors of the application.',
                systemSettings: 'Allows the configuration of imenuapps integration with third-party applications.',
            ...
            options:{
                ...
                manageBasicSettings: 'Restaurant',
            ...
            titles:{
                ...
                cancellationType: 'Cancelation type',
            ...
            list:{
                ...
                messages:{
                    ...
                    deleteRestaurant: 'Do you want to delete this restaurant?',
                    ...
                    deleteSuscriptor: 'Do you want to delete this suscriptor?',
                    ...
                    messageDeleteSuccessRestaurant: 'Restaurant was successfully deleted',
                    ...
                    messageDeleteSuccessSuscriptor: 'Suscriptor was successfully deleted',
                    
                    messageActivareSuccessSuscriptor: 'Suscriptor was successfully activate',
                    messageDesactivareSuccessSuscriptor: 'Suscriptor was successfully desactivate',
                    ...
                    messageEditSuccessSuscriptor: 'The suscriptor was edited successfully',
                    ...
                    messageCreateSuccessSuscriptor: 'The suscriptor was created successfully',
            ...
            form: {
                ...
                titles:{
                    ...
                    suscriptionNewTitle: 'Create a new suscription',

                    driversNewTitle: 'Create a new driver',
                    userEditTitle: 'Edit staff member',

                    suscriptionEditTitle: 'Edit suscription',
                    ...
                    funSettingEditTitle: 'Funtionalities Settings',
                ...
                fields:{
                    ...
                    mustClockinMss: 'You must clockin first. Please, ',
                    ...
                    authenticationTokenFB: "FB Authorization token", 
                ...
                validate:{
                    ...
                    ingredient: 'Ingredient already exist.',
                },
                permissionsGroup: {
                    ...
                    permissionDriver: 'DRIVER SUPERVISION PERMISSION',
                    permissionOrder: 'ORDER PERMISSION',
                    permissionRole: 'ROLE PERMISSION',
                    permissionSetting: 'SETTING PERMISSION',
                    permissionPayment: 'PAYMENT PERMISSION',
                    permissionClockin: 'CLOCKIN PERMISSION',
                    ...
                    permissionSuscriptors: 'SUSCRIPTORS PERMISSION',
                    ...
                    canCreateSuscriptor: 'Can create suscriptors',
                    canViewSuscriptor: 'Can view suscriptors',
                    canEditSuscriptor: 'Can edit suscriptors',
                    canDesactivateSuscriptor: 'Can desactivate suscriptors',
        ...
        frontend:{
            ...
            reservation:{
                ...
                quotationMessage2: 'and this amount will be deducted from your order if you place an order with us. ',
            ...
            createNew: {
                restaurantName: 'Restaurant name',
                restaurantAddres: 'Restaurant address',
                restaurantPhone: 'Restaurant phone',
                restaurantEmail: 'Restaurant email',
                restaurantZipcode: 'Restaurant zipcode',
                restaurantWeb: 'Restaurant website',
                restaurantFax: 'Restaurant fax',
                ...
                createTitle: 'Create new restaurant in iMenuApps',
                dataRestaurant: 'Restaurant details',
                dataMercahnt: 'Merchant data',
                restaurants:'Restaurants',
                createdMessage: 'The restaurant was created successfully. You will receive an email with the password to access the application ' ,
                clerkToLong: 'Pin value exceeded, maximum allowed 99999', 
                clerkNotValid: 'Not valid Pin',
            ...
            unsubscribe: {
                ...
                restaurantFail: 'Restaurant not found',
            },
            specialsPrice: {
                ...
                activeRule: 'Only one rule at a time will be applied. The first one activated will take precedence.'
            } 
        }
    },
    es: {
        ...
        backoffice:{
            menu:{
                session: 'Sesión',
                foodServices: 'Comida/Servicios',
                ordersTickets: 'Órdenes/Tickets',
                reservationsDeliveries: 'Reservaciones/Entregas',
                restaurantAdministration: 'Administración del Restaurante',
                staffOccupationsCustomersDrivers: 'Staff/Ocupaciones/Clientes/Choferes',
                marketing: 'Marketing',
                settings: 'Configuraciones',
            },
            controlPanel:{
                staff: 'Creación de cuentas de usuario de los trabajadores del restaurante.',
                occupations: 'Gestión de las ocupaciones del restaurante. Las ocupaciones están relacionadas con los miembros del staff. Cada miembro tiene una ocupación específica.',
                roles: 'Gestión de roles. Los roles establecen los permisos sobre las diferentes áreas de la aplicación y están relacionados con los miembros del staff. Un miembro del staff puede tener varios roles.',
                customers: 'Muestra un listado de los clientes del restaurante.',
                categories: 'Gestiona las distintas categorías de los menús. Las categorías están relacionadas con los elementos del menú. Un elemento de menú pertenece a una categoría.',
                menuItems: 'Gestión de los elementos del menú. Un menú está compuesto por categorías, y a su vez, los elementos del menú se relacionan con el menú a través de las categoría a la que pertenece.',
                services: 'Gestión de los servicios. Los servicios se usan en los menús de catering.',
                menus: 'Gestión de los menús. Permite la gestión de menús. Un menú está compuesto por diversas categorías.',
                orders: 'Permite la visualización y la creación de órdenes.',
                cateringOrders: 'Permite la visualización de órdenes de catering.',
                orderForDelivery: 'Muestra un listado de las órdenes que están listas para ser entregadas al chofer que le ha sido asignado la orden.',
                tickets: 'Permite la creación y el seguimiento de tickets. Los tickets son órdenes que se mantienen abiertas mientra el cliente siga consumiendo.',
                otherCharges: 'Permite la gestion de cargos adiciones por cantidad de productos.',
                taxes: 'Gestión de impuestos.',
                deliveries: 'Gestión de los precios de entrega.',
                reservations: 'Gestión de reservaciones y listas de espera.',
                tables: 'Gestión de las capacidades del restaurante.',
                payments: 'Muestra el listado de las transacciones de pago realizadas.',
                aboutSettings: 'Permite la gestión del slider que aparece en la página de inicio de cada restaurante.',
                paymentSettings: 'Permite la configuración de la pasarela de pago que se utilizará para procesar las transacciones.',
                basicSettings: 'Permite la configuración de los datos principales del restaurante: Nombre, Dirección, Teléfono. Esta información aparece en la página principal de cada restaurante.',
                funtionalitiesSettings: 'Permite la configuración del funcionamiento general del restaurante: Horarios, Zip codes, propinas...',
                colorSettings: 'Permite la configuración de los colores de la aplicación.',
                systemSettings: 'Permite la configuración de la integración de imenuapps con aplicaciones de terceros.',
            ...
            options:{
                ...
                manageBasicSettings: 'Restaurante',
            ...
            list:{
                ...
                messages:{
                    ...
                    deleteRestaurant: 'Quiere eliminar este restaurante?',
                    ...
                    messageDeleteSuccessRestaurant: 'El restaurante fue eliminado satisfactoriamente',
                    ...
                    messageDeleteSuccessOtherCharges: 'El cargo fue eliminado satisfactoriamente',
                    messageDeleteSuccessNewsletter: 'El boletín fue eliminado satisfactoriamente',
                    ...
                    messageDeleteSuccessSuscriptor: 'El suscriptor fue eliminado satisfactoriamente',
                    messageActivareSuccessSuscriptor: 'El suscriptor fue activado satisfactoriamente',
                    messageDesactivareSuccessSuscriptor: 'El suscriptor fue desactivado satisfactoriamente',
                    ...
                    messageEditSuccessSuscriptor: 'El suscriptor fue editado satisfactoriamente',
                    ...
                    messageCreateSuccessSuscriptor: 'El suscriptor fue creado satisfactoriamente',
        ...
        frontend:{
            ...
            order:{
                ...
                messgForContactCatering:'Debe iniciar sesión para crear orden de Catering',
                date:'Fecha',
                state0:'Abandonada',
                state1: 'Ordenada',
                state2:'En Cocina',
            ...
            createNew: {
                restaurantName: 'Nombre del restaurante',
                restaurantAddres: 'Dirección del restaurante',
                restaurantPhone: 'Teléfono del restaurante',
                restaurantEmail: 'Correo del restaurante',
                restaurantZipcode: 'Zipcode del restaurante',
                restaurantWeb: 'Web del restaurante',
                restaurantFax: 'Fax del restaurante',
                merchantName: 'Nombre del comerciante',
                merchantLastName: 'Apellido del comerciante',
                merchantAddres: 'Dirección del comerciante',
                merchantZipcode: 'ZipCode',
                merchantPhone: 'Telefóno del comerciante',
                merchantEmail: 'Correo del comerciante',
                merchantClerk: 'Pin del usuario (1 - 99999)',
                createTitle: 'Crear nuevo restaurante en iMenuApps',
                dataRestaurant: 'Datos del restaurante',
                dataMercahnt: 'Datos del comerciante',
                restaurants:'Restaurantes',
                createdMessage: 'El restaurante se ha creado correctamente. Recibirá un correo con la contraseña para acceder a la aplicación',
            ...
            unsubscribe: {
                ...
                restaurantFail: 'Restaurante no encontrado',
            },
            specialsPrice: {
                ...
                activeRule: 'Solo se aplicará una regla a la vez. El primero que se active tendrá prioridad', 
            }
