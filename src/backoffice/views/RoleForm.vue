...
export default {
  ...
  data () {
    return {
      ...
      suscriptorPermissions: [
        ...
        { id: 'canEditSuscriptor', val: this.$t('backoffice.form.permissionsGroup.canEditSuscriptor'), isChecked: false },
        { id: 'canDesactivateSuscriptor', val: this.$t('backoffice.form.permissionsGroup.canDesactivateSuscriptor'), isChecked: false },
      ],
      tablePermissions: [
  ...
  methods: {
    ...
    selectDeselectSuscriptor(){
        ...
        {
            this.suscriptor_color = 'danger'
            this.suscriptor_title = 'Deselect all'
        }  
        else{
            this.suscriptor_color = 'success'
            this.suscriptor_title = 'Select All'
        }

        this.suscriptorPermissions.forEach(permission => {
            if (this.suscriptor)
                permission.isChecked = true;
            else
                permission.isChecked = false;
    ...
    saveRole: function(){
        ...
        if (this.isValidForm())
        {
            ...
            let item = {
                ...
                "canDesactivateSuscriptor": this.suscriptorPermissions[3].isChecked,
