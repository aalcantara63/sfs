            ...
            <tr>
                ...
                <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                    ...
                    <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                        <a href="http://www.example.com/" style="text-decoration:none;"><img :src="restaurant.restaurantLogo" width="165" alt="Logo" style="width:80%;max-width:165px;height:auto;border:none;text-decoration:none;color:#ffffff;"></a>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td style="padding:30px;text-align:center;font-size:12px;background-color:#404040;color:#cccccc;">
                        <p v-if="restaurant.restaurantName != '' && restaurant.restaurantAddress != ''">
                            {{restaurant.restaurantName}} is in {{restaurant.restaurantAddress}}
                        </p>
                        <p v-if="restaurant.restaurantPhone != ''">
                            Call us: {{restaurant.restaurantPhone}}
                        </p>
                        <p v-if="restaurant.restaurantWeb != ''" style="margin:0 0 8px 0;">
                            Visit our web site: <a target="_blank" :href="restaurant.restaurantWeb">{{restaurant.restaurantWeb}}</a>
                        </p>
                        <p style="margin:0 0 8px 0;">
                            <a v-if="restaurant.restaurantFacebok != ''" :href="restaurant.restaurantFacebok" style="text-decoration:none;"><img src="https://assets.codepen.io/210284/facebook_1.png" width="40" height="40" alt="f" style="display:inline-block;color:#cccccc;"></a> 
                            <a v-if="restaurant.restaurantTwitter != ''" :href="restaurant.restaurantTwitter" style="text-decoration:none;"><img src="https://assets.codepen.io/210284/twitter_1.png" width="40" height="40" alt="t" style="display:inline-block;color:#cccccc;"></a>
                        </p>
                        <p style="margin:0;font-size:14px;line-height:20px;">&reg; iMenuApps {{currentYear}}<br><a class="unsub" href="http://www.example.com/" style="color:#cccccc;text-decoration:underline;">Unsubscribe instantly</a></p>
                    </td>
                    </tr>
                </table>
                </td>
